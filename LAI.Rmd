...
You will run numerical experiments using the Canadian Land Surface Scheme Including Biogeochemical Cycles ([CLASSIC](https://cccma.gitlab.io/classic_pages/)). The model is compiled on the Centre for Advanced Computing - Queen's University cluster. To access the cluster, follow the instructions below: 

* Generate a [public/private rsa key pair](https://docs.alliancecan.ca/wiki/SSH_Keys). To do this, open a terminal (Power shell in windows), type "ssh-keygen" and follow the prompts, e.g.
...
* Go into your .ssh folder and get the public key from your local machine

```{r, echo = TRUE, eval=FALSE}
PS C:\Users\seile\> cd .ssh
PS C:\Users\seile\.ssh> ls

Mode                 LastWriteTime         Length Name
----                 -------------         ------ ----
-a----        2023-03-22   8:29 PM           2610 id_rsa
-a----        2023-03-22   8:29 PM            576 id_rsa.pub

PS C:\Users\seile\.ssh> cat .\id_rsa.pub
ssh-rsa AAAAB3Nza (...)
```

* Go to [Digital Research Alliance of Canada log in site](https://code.visualstudio.com/download)
* Log in
* Copy-paste the content of your SSH public key from local machine to CCDB
* You should now be able to access different HPCs. To test this, type: 

```{r, echo = TRUE, eval=FALSE}
ssh -Y yourUserName@beluga.computecanada.ca
```

* Install Visual Studio Code from [here](https://code.visualstudio.com/download)
* In VS code, install the extensions Remote-SSH and Remote-Explorer
* Add the SSH targets to your remote explorer
...
* Install [File Zilla](https://filezilla-project.org/) 
* Host: sftp://beluga.computecanada.ca 
