...
* Go into the new spinup folder and edit the paths in  ```classic_submit_gridCell.sh```, replacing ```/global/home/sa119014/template/job_options_spinup.txt 120/65``` with ```/global/home/sa119xxx/spinup/job_options_spinup.txt 120/65```

* Go into the new spinup folder and edit the paths in  ```job_options.txt```, replacing ```rs_file_to_overwrite ='/global/home/sa119014/template/rsFile.nc``` with ```rs_file_to_overwrite ='/global/home/sa119xxx/spinup/rsFile.nc```
...
* This restart file is located in your spinup folder:

```{r, engine = 'bash', eval = FALSE}
/global/home/sa119xxx/spinup/rsFile.nc
```

* We will add this path in your ```job_options.txt``` file as described below.
...
* Next, open the ```job_options.txt``` file and set the path of the initialization file to the location where the restart file is located:

```{r, engine = 'bash', eval = FALSE}
init_file ='/global/home/sa119xxx/spinup/rsFile.nc'
```
