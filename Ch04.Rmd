...
answer("The relative sepcificity decreases with temperature because the Michaelis-Menten coefficient for carboxylation increases more strongly compared to the Michaelis-Menten coefficient for oxygenation", correct = TRUE),
answer("The relative sepcificity decreases with temperature because the Michaelis-Menten coefficient for carboxylation increases less strongly compared to the Michaelis-Menten coefficient for oxygenation"),
  allow_retry = TRUE
)
```
...
```{r PGA01, echo=FALSE}
question_numeric("How many PGA molecules are produced during the assimilation of 2 O2 molecules?",
